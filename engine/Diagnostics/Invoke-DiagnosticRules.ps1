...
# 1/2: freier Platz auf dem Systemlaufwerk. Kritisch und Warnung sind gegenseitig exklusiv.
if (Test-HasProperty -Object $Snapshot -Name 'Storage' -and Test-HasProperty -Object $Snapshot.Storage -Name 'Volumes') {
    ...
    # 3: logischer Datenträger meldet einen auffälligen Gesundheitszustand.
    ...
    # 4: physischer Datenträger meldet einen auffälligen Gesundheitszustand.
...
# 5: auffällig viele Autostart-Einträge. Kein Kausalitätsbeweis.
...
# 11/12: Momentaufnahmen werden absichtlich mit geringerer Sicherheit bewertet.
...
# 13: Ereignisse sind ein Hinweis, niemals alleiniger Fehlerbeweis.
